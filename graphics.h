 ...
 * @param color - new color for the pixels
 */
extern void fillScreenColor(Color color);
...
/**
 * Print text vertically facing left
 *
 * @param x - left position of text
 * @param y - top position of text
 * @param text - the text to print
 * @param color - new color for the pixels
 */
extern void printTextScreenVertLeft(int x, int y, const char* text, u32 color);

/**
 * Print text vertically facing right
 *
 * @param x - left position of text
 * @param y - top position of text
 * @param text - the text to print
 * @param color - new color for the pixels
 */
extern void printTextScreenVertRight(int x, int y, const char* text, u32 color);

/**
 * Print a centered text (pixels out of the screen or image are clipped).
 * @param text - the text to print
 * @param color - new color for the pixels
 */
extern void printTextCenter(const char* text, u32 color);

/**
 * Print a centered text (pixels out of the screen or image are clipped).
 * @param text - the text to print
 * @param color - new color for the pixels
 * @param y - the y coord of where to draw
 */
extern void printTextCenter(const char* text, Color color, int y);
...
/**
 * Draw a rectangle border to screen.
 *
 * @pre x0 >= 0 && x0 < SCREEN_WIDTH && y0 >= 0 && y0 < SCREEN_HEIGHT &&
 *      x1 >= 0 && x1 < SCREEN_WIDTH && y1 >= 0 && y1 < SCREEN_HEIGHT
 * @param x0 - x line start position
